        ...
        if (source == "coinpaprika")
        {
            ...
            if (rel_ticker != "")
            {
                ...
                <style>
                  ...
                  div.cp-widget__main [class*="cp-widget-select"],
                  div.cp-widget__main [class*="cp-widget__chart-ranges"] {
                    position: absolute !important;
                  ...
                  div.cp-widget__main [class*="cp-widget-select"] label,
                  div.cp-widget__main [class*="cp-widget-select"] div,
                  div.cp-widget__main [class*="cp-widget-select"] span,
                  div.cp-widget__main [class*="cp-widget-select"] button,
                  div.cp-widget__main [class*="cp-widget__chart-ranges"] button,
