...
message(STATUS "Performing Windows application bundle pruning...")
set(WIN_QML_DIR "${PROJECT_APP_PATH}/qml")
if (EXISTS "${WIN_QML_DIR}")
    message(STATUS "Cleaning unused items from Windows QML directory: ${WIN_QML_DIR}")
    file(REMOVE_RECURSE "${WIN_QML_DIR}/QtQuick/Controls")
    file(REMOVE_RECURSE "${WIN_QML_DIR}/QtQuick/PrivateWidgets")
    set(WIN_C2_DIR "${WIN_QML_DIR}/QtQuick/Controls.2")
    file(REMOVE_RECURSE "${WIN_C2_DIR}/designer" "${WIN_C2_DIR}/Fusion" "${WIN_C2_DIR}/Imagine" "${WIN_C2_DIR}/Universal")
    file(REMOVE_RECURSE "${WIN_QML_DIR}/QtWebEngine/Controls1Delegates")
endif()
set(WIN_PAK_DIR "${PROJECT_APP_PATH}/translations/qtwebengine_locales")
if (EXISTS "${WIN_PAK_DIR}")
    message(STATUS "Filtering Windows QtWebEngine localization packs inside: ${WIN_PAK_DIR}")
    file(GLOB WIN_CHROMIUM_PAKS "${WIN_PAK_DIR}/*.pak")
    foreach(PAK_FILE ${WIN_CHROMIUM_PAKS})
